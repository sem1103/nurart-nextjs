...
import s from '../../[locale]/prod/ProductsPage.module.css';
    ...
    return (
        <>
            ...
            <div className={`container ${s.products__page}`}>
                ...
                <div className={`${s.carts__wrapper} ${s.carts} ${e.cart__page}`}>
                    {cartItems.length ? (
                        <div className={e.container}>
                                    ...
                                    {cartItems.map(item => {
                                        ...
                                        return (
                                            <div className={e.cart__item} key={item.id}>
                                                ...
                                                <h3>{text || (lang === 'az' ? item.productAz.productName : item.productRu.productName)}</h3>
                            ...
                            <div className={e.form__container}>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className={e.form}>
