...
export function generateMetadata({ params }) {
    ...
    const metadata = {
      ...
      az: {
        ...
        description: "Tanış olun bizim rəqəmsal çap xidmətlərimizlə. Viza kartlarının, bukletlərin, broşurların, afişaların, kataloqların, plastik kartlarının, beyjiklərin, nışanların, ştampların və digər çap məhsullarının keyfiyyətli və tez çapını təmin edirik. Əlavə məlumat üçün bizimlə əlaqə saxlayın!",
        openGraph: {
          title: 'Rəqəmsal Çap. NurArt - Professional Dizayn və Çap',
          description: 'Tanış olun bizim rəqəmsal çap xidmətlərimizlə. Viza kartlarının, bukletlərin, broşurların, afişaların, kataloqların, plastik kartlarının, beyjiklərin, nışanların, ştampların və digər çap məhsullarının keyfiyyətli və tez çapını təmin edirik. Əlavə məlumat üçün bizimlə əlaqə saxlayın!',
          siteName: 'NurArt.az',
