...
export default function Stamp() {
    ...
    useEffect(() => {
        console.log(items.shtamp.sort((a,b) => a.productName < b.productName ? -1 : 1));
    ...
    return (
        ...
        <>
            ...
            <div className={`container ${s.products__page}`}>
                ...
                <FilterCategory filterCategories={filters.shtamp} filterByCategory={filterCategory} filterByName={searchByName} placeholder={t('searchByCode')} />
                ...
                <div className={s.carts__wrapper} ref={containerRef}>
                    ...
                    {
                        (!items.shtamp.length && !loader) && <h3>{t('notFound')}</h3>
                    }
