...
export function generateMetadata({ params }) {
  const metadata = {
    ru: {
      title: "Промо-продукты: рекламные баннеры, наклейки, ручки с логотипом, кружки и многое другое. NurArt: Профессиональный дизайн и Печать",
    ...
    az: {
      title: 'Promo Məhsulları: banner reklamları, stikerlər, logo qələmlər, Kupalar və daha çox. NurArt: Professional dizayn və çap',
