    ...
    return (
        ...
        <>
            ...
            <div className={`container ${s.products__page}`}>
                ...
                <FilterCategory filterCategories={filters.polygraphy} filterByCategory={filterCategory} filterByName={searchByName} placeholder={t('searchByName')} />
                ...
                <div className={`${s.carts} ${s.carts__wrapper}`} ref={containerRef}>
                    {loader &&  !allItems.polygraphy.length ? <Loader /> :
                        visibleProducts.map(item => {
                            ...
                            return (
                                <div onClick={() => filterCategory(item.categories[0].value, item.categories[0].label)}>
                    ...
                    {
                        (!items.polygraphy.length && !loader) && <h3>{t('notFound')}</h3>
                    }
                </div>
            </div>
