...
export default function Header({lang}){
    ...
    return (
        <>
                    ...
                    <div className={s.right}>
                        ...
                        <div className={s.menu}>
                            ...
                            <nav>
                                <ul>
                                    <li>
                                        <Link className={router == '/prod/polygraphy' ?  'active' : ''} href='/prod/polygraphy' onClick={() => {
                                            burgerMenuHandler();
                                        }} ref={productNav}>products</Link>
                                    </li>
                                    <li>
                                        <Link href='' onClick={() => {
                                            burgerMenuHandler();
                                    ...
                                    <li className={s.submenu}>
                                        services
                                        <ul>
                                            <li><Link onClick={() => burgerMenuHandler()} href=''>design</Link></li>
                                            <li><Link onClick={() => burgerMenuHandler()} href=''>digitPrint</Link></li>
                                            <li><Link onClick={() => burgerMenuHandler()} href=''>ofsetPrint</Link></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <Link href='' onClick={() => burgerMenuHandler()}>about</Link>
                                    </li>
                                    <li>
                                        <Link href='' onClick={() => burgerMenuHandler()}>contact</Link>
                                    </li>
                                </ul>
                            </nav>
            ...
            <ThanksModal modalTitle=requestModalTitle modalText=orderModalText />
