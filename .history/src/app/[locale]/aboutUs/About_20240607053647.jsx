        ...
        <>
            <div className={s.about}>
                ...
                <div className={s.right}>
                    <h1>{t('title3')}</h1>
                    <p dangerouslySetInnerHTML={{__html: t('text3')}} />
                </div>
