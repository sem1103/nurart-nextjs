...
export function generateMetadata(language) {
  const metadata = {
    ru: {
    ...
    az: {
      title: "About Us - NurArt Printing: Professional Design and Printing",
  ...
  return metadata[language] || metadata['az']; // По умолчанию возвращает метаданные на английском, если язык не найден
}
