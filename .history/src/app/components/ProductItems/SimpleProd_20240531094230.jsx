...
import img from 'public/assets/img/polygraphy/blur.webp'
...
export default function SimpleProd({item, openOrderModal}) {
    ...
    return (
        <div className={`${s.cart} ${s.simpleProd}`}>
            ...
            <Image src={item.img} alt="" className={s.cart__img} placeholder="blur" width={360} height={200} blurDataURL="@/public/assets/img"/>
