                    ...
                    <div className={s.right}>
                        ...
                        <div className={s.menu}>
                            ...
                            <nav>
                                <ul>
                                    <li>
                                        <Link href='/prod/polygraphy' onClick={() => {
                                            burgerMenuHandler();
                                    ...
                                    <li className={s.submenu}>
                                        {t('services')}
                                        <ul>
                                            <li><Link onClick={() => burgerMenuHandler()} href='design-service'>{t('design')}</Link></li>
                                            <li><Link onClick={() => burgerMenuHandler()} href='digit-print'>{t('digitPrint')}</Link></li>
                                            <li><Link onClick={() => burgerMenuHandler()} href='ofset-print'>{t('ofsetPrint')}</Link></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <Link href='about' onClick={() => burgerMenuHandler()}>{t('about')}</Link>
                                    </li>
                                    <li>
                                        <Link href='sa' onClick={() => burgerMenuHandler()}>{t('contact')}</Link>
                                    </li>
                                </ul>
                            </nav>
                            ...
                            <ul className={`${s.header__tools} header__tools`}>
                                ...
                                <li className={s.favorites}>
                                    ...
                                    <Link href='/favorites' onClick={() => burgerMenuHandler()}>
                                ...
                                <li className={s.card}>
                                    <Link href='/cart' onClick={() => burgerMenuHandler()}>
                            ...
                            <div className={s.toggle__container}>
                                ...
                                <label onClick={() => changeLang()} className={s.toggle} for="check">
                                    <input  {i18next.language == 'ru' && checked} id={s.check} name="check" type="checkbox" />
