...
export default async function getServerSideProps(){
    const data = await fetch('https://api.nurart.az/wp-json/wp/v2/poliqrafiya/').then(res => res.json());
...
export default function Polygraphy({allData}) {
    ...
    useEffect(() => {
        ...
        !allItems.polygraphy.length && fetchData(allData);
    }, []);
