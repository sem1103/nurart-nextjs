...
export default function Polygraphy() {
    ...
    const [loadedCount, setLoadedCount] = useState(2); // Начальное количество загружаемых товаров
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            const { scrollTop, scrollHeight, clientHeight } = document.querySelector('body');
