...
export default function Polygraphy() {
    ...
    const [loadedCount, setLoadedCount] = useState(5); // Начальное количество загружаемых товаров
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if (scrollHeight - scrollTop === clientHeight) {
              ...
              setLoadedCount(prevCount => prevCount + 5); // Увеличиваем количество загружаемых товаров
            }
          };
          ...
          // Удаляем слушатель события прокрутки при размонтировании компонента
          return () => {
