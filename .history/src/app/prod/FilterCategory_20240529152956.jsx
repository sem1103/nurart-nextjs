    ...
    return (
        <>
            <ul className={`${s.categoryes} categoryes`}>
                <li><Link to='/prod/polygraphy' >{t('navPolygrafy')}</Link></li>
                <li><Link to='/prod/stamp'>{t('navStamb')}</Link></li>
                <li><Link to='/prod/plastic-cards'>{t('navCart')}</Link></li>
                <li><Link to='/prod/promo-products'>{t('navPromo')}</Link></li>
                <li><Link to='/prod/vinil-products'>{t('navVinil')}</Link></li>
            </ul>
