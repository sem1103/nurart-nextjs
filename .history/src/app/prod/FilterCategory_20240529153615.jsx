    ...
    return (
        <>
            <ul className={`${s.categoryes} categoryes`}>
                <li><Link href='/prod/polygraphy' >{t('navPolygrafy')}</Link></li>
                <li><Link href='/prod/stamp'>{t('navStamb')}</Link></li>
                <li><Link href='/prod/plastic-cards'>{t('navCart')}</Link></li>
                <li><Link href='/prod/promo-products'>{t('navPromo')}</Link></li>
                <li><Link href='/prod/vinil-products'>{t('navVinil')}</Link></li>
            </ul>
