...
export default function SimpleProd({item, openOrderModal, filterCategory}) {
    let lang = useLocale();
    ...
    return (
        <div className={`${s.cart} ${s.simpleProd}`} onClick={() => filterCategory(item.categories[0].value, item.categories[0].label)}>
            ...
            <Image src={item.img} alt={lang == 'az' ? item.productAz.productName : item.productRu.productName} className={s.cart__img} placeholder="blur" width={360} height={200} layout="responsive"
 blurDataURL="data:image/webp;base64," />
            <div className={s.cart__desc}>
                <h3 ref={itemName}>{lang == 'az' ? item.productAz.productName : item.productRu.productName}</h3>
                <div dangerouslySetInnerHTML={{ __html: lang == 'az' ? item.productAz.desc : item.productRu.desc }} />

                <div className={s.cart__btns}>
                    {
                        item.cartItem ? <Link href={`/${lang}/cartPage`}>{t('inCart')}</Link> 
                        : 
                        <button onClick={() => {
                            addCartItem(item);
                         }}>{t('toCard')}</button>
